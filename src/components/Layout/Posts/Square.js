...
const Square = (({image, cat, desc, alt, title, onClick, setRef, isActive}) => {
    return (
      <div onClick={onClick} ref={setRef} className={`${isActive? styles.active : ''} ${styles.squareType} ${styles.postBlog}`}>
