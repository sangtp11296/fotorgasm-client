...
//   transform: translate3d(${props.click===1?'0':`{props.boxWidth}`})
...
const Gallery = (props) => {
  ...
  return (
    <div className={`${styles.masonryItem} ${styles.layoutPost}`} ref={targetRef}>
      ...
      <div className={styles.carouselWrapper} st>
        <div className={styles.slideCarousel}>
          <div className={styles.outerWrapper}>
            <div className={styles.imageWrapper} style={{width:`${boxWidth*3}px`}}>
              ...
              <div className={styles.imageItem} style={{width:`${boxWidth}px`}}>
                <div className={styles.imageBackground} style={{backgroundImage:`url('https://images.unsplash.com/photo-1516483638261-f4dbaf036963?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1286&q=80')`}}>
                  <Link to='post/:id'></Link>
                </div>
              </div>
              <div className={styles.imageItem} style={{width:`${boxWidth}px`}}>
                <div className={styles.imageBackground} style={{backgroundImage:`url('https://images.unsplash.com/photo-1452421822248-d4c2b47f0c81?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80')`}}>
                  <Link to='post/:id'></Link>
                </div>
              </div>
            </div>
